        ...
        <v-tabs v-model="active">
          ...
          <v-tab-item key="response" ripple>
            ...
            <v-radio-group 
            	...
            	style="width:100%;"
            >
            <!-- <pre style="caption">{{nominals}}</pre>
              <v-radio  v-for="alt in nominals" :value="alt.id">
              	<template slot="label">
              		<v-row class="mx-2">
              			<v-col>{{alt.title}}</v-col>
              			<v-col cols="1" v-if="options.showUserInfo && alt.user">
              ...
              <v-layout align-center justify-end row fill-height v-for="alt in nominals" style="padding-bottom: 0.5em; cursor: pointer;" @click="select(alt.id)">
                <div style="width:2em;">
