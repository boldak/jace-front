  ...
  <v-container fluid>
    <v-layout wrap>
      ...
      <v-flex xs12>
        ...
        <editor v-show="mode == 'embedded'" :content="embeddedSource" lang="dot" :sync="true" @change="onUpdateSource" style="border:1px solid #999">
        </editor>
        <v-layout column v-show="mode == 'dps'">
          ...
          <editor :content="config.data.script" lang="dps" :sync="true" @change="onUpdateScript" @mount="setEditor" style="border:1px solid #999;height:350px !important">
          </editor>
        </v-layout>
      </v-flex>
    </v-layout>
...
import snippetTree from "../../widget-share/dps/dps-snippets-tree.vue"
