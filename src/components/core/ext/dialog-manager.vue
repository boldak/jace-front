<template>
	...
	<div v-for="dialog,index in items" :key="index">	
		<v-dialog
		        ...
		        :width="dialog.props.width"
		        :height="dialog.props.height"
		        :persistent="dialog.props.persistent"
		        :hide-overlay="dialog.props.hideOverlay"
		      >
	 	...
	 	methods:{
	 		...
	 		resolver(id, resolve) {
	 			...
	 			return result => {
	 				...
	 				let dialog = this.items.splice(index,1)[0]
