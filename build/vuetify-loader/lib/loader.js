...
const jaceCompiler = require("../../jace-loader/src/jace-compiler.js")
const jaceOptions = require("../../../jace.config.js")
...
module.exports = async function (content, sourceMap) {
  ...
  if (!this.resourceQuery) {
    ...
    const tags = new Set()
    const attrs = new Set()
    let file = (await readFile(this.resourcePath)).toString('utf8')
    file = jaceCompiler(file, jaceOptions)

    // console.log("VUETIFY LOADER > ",this.resourcePath)
    // console.log(file)
